  ...
  return (
    <div className="flex h-full min-h-0 flex-col overflow-y-auto px-4 py-6">
      <div className="mx-auto grid w-full max-w-6xl gap-5 lg:grid-cols-[1fr_20rem]">
        <section className="rounded-[2rem] border bg-card p-8 text-card-foreground shadow-sm">
          <div className="flex min-h-104 flex-col items-center justify-center rounded-[1.5rem] border border-dashed bg-muted/40 px-6 text-center">
            <div className="mb-5 flex size-16 items-center justify-center rounded-3xl bg-primary text-primary-foreground shadow-lg">
            ...
            <button
              className="mt-6 inline-flex h-10 items-center gap-2 rounded-xl bg-primary px-4 font-medium text-primary-foreground text-sm shadow-sm transition-colors hover:bg-primary/90"
              type="button"
            >
        ...
        <aside className="space-y-4">
          <div className="rounded-3xl border bg-card p-4 text-card-foreground shadow-sm">
            ...
            <p className="mt-2 text-muted-foreground text-xs">占位统计：1.8 GB / 10 GB</p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-muted-foreground text-xs">即将支持同步管理</p>
                  </div>
